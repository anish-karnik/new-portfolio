...
export function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 pt-16 relative overflow-hidden"
    >
      <ParticlesBackground />
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          >
            <div className="relative">
              ...
              >
                <img
                  src="https://i.pinimg.com/236x/6b/a2/2e/6ba22ebaf2c9de654de498838c84aa35.jpg"
                  alt="Profile"
